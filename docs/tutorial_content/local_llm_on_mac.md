...
# IMPORTANT: For thinking models (Qwen3.5), send a warm-up request after server start —
# first request has 0% KV cache reuse and produces extremely long reasoning
```
